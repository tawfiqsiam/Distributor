...
client.on('message', msg =>{
    if (msg.content === '=help'){
         ...
         .addField("__Some more accounts__ \n =crunchyroll: Crunchyroll \n =minecraft: Minecraft" , "More accounts coming soon! Join the support server for more info on resstoks: https://discord.gg/e9kzWCE")
...
if (message.content === '=minecraft'){
    ...
    var string = 
    `https://up-to-down.net/43300/000011  If the account doesnt work it means someone already claimed it.`
    var words = string.split('\n');
    let random = words[Math.floor(Math.random()*words.length)];
    message.reply("Check your DMs")
    message.author.send(`${random}`);      
